    ...
    >
      ...
      >
        ...
        <div className="pt-[115px]">
          ...
          <p className={`${kufam.className} pl-[28px] pl-[58px]`}>
            Inovações como:
          </p>
        ...
        <div className="pt-[220px]">
          <h3 className={` pl-[48px] text-[2.5rem] ${koulen.className}`}>
            Colossus I<span className={`text-green-600 `}> (1943)</span>
          </h3>
          <p className={` pl-[28px] pt-[25px] text-[1.8rem] ${khand.className} text-green-100`}>
          ...
          <h2 className={`${khand.className} text-green-400`}>Não podemos esperar que uma máquina nos dê uma resposta,<br/>  sem antes fornecermos<br/>  a ela uma pergunta<br/>  adequada. - Alan Turing</h2>
          </p>
        </div>

        <div className="pt-[150px] pl-[28px]">
          ...
          <p className={` pt-[40px] text-neutral-200`}>
